...
scoreboard objectives add _hgr_ food "Food Points"
...
scoreboard players remove @a[scores={_ast_=-599..,_air_=..200}] _ast_ 1
scoreboard players remove @a[scores={_ast_=-598..,_air_=..100}] _ast_ 2
tag @a[scores={_dct_=1..}] remove _spn_
scoreboard players set @a[tag=!_spn_] _ast_ -2400
scoreboard players set @a[scores={_hp_=..0}] _ast_ -2400
